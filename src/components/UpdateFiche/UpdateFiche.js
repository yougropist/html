...
class UpdateFiche extends Component{
      ...
      render(){
        ...
        return(       
            <li class="list-group-item">  
                ...
                <input ref={`champ${this.props.champs}`} className={this.state.updateOn === this.props.data['id'] && "active" } disabled={this.state.updateOn === this.props.data['id'] ? false : true} type="text" defaultValue={this.props.data[this.props.champs]}/>
            </li>               
        ) 
      }
